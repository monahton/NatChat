...
NatChat is an R package designed to facilitate seamless interaction with the current issues of journals published by the Nature Portfolio. It provides functions to:
